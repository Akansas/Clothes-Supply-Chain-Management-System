@extends('layouts.app', ['activePage' => 'upgrade', 'title' => 'Clothes Supply Chain Management System', 'navName' => 'Upgrade', 'activeButton' => 'laravel'])
                        ...
                        <div class="col-md-8 ml-auto mr-auto">
                            <div class="card">
                                <div class="header text-center">
                                    <h4 class="title">{{ __('Clothes Supply Chain Management System')}}</h4>
                                    <p class="category">{{ __('Are you looking for more components? Please check our Premium Version of Clothes Supply Chain Management System.')}}</p>
                                    <br>
                                </div>
