...
<div class="container py-5">
    <h2 class="fw-bold mb-4">Create Facility Visit</h2>
    <form method="POST" action="{{ route('inspector.facility-visits.store') }}">
        @csrf
        <div class="row mb-3">
            <div class="col-md-6">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="datetime-local" name="actual_visit_date" id="actual_visit_date" class="form-control">
            </div>
        </div>
        <div class="mb-3">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <textarea name="visit_notes" id="visit_notes" class="form-control" rows="4"></textarea>
            </div>
            <div class="col-md-6">
        ...
        <button type="submit" class="btn btn-primary">Create Facility Visit</button>
